...
var Login = function Login(props) {
  ...
  var getOldUsers = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              oldUsers = allUsers !== null ? allUsers : [];
            ...
            case 6:
              _context.t0 = JSON;
              _context.next = 9;
              return _asyncStorage.default.getItem("@users");
            case 9:
              _context.t1 = _context.sent;
              _allUsers = _context.t0.parse.call(_context.t0, _context.t1);
              oldUsers = _allUsers !== null ? _allUsers : [];
              console.log(oldUsers);
            case 13:
            case "end":
    ...
    return function getOldUsers() {
      return _ref.apply(this, arguments);
    };
  }();
  var getValueUsername = function getValueUsername() {
    return function (params) {
      console.log(params);
      User.userName = params;
    };
  };
  var getValueEmail = function getValueEmail() {
    return function (params) {
      console.log(params);
      User.email = params;
    };
  };
  var navigateToGame = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var newUsers, find, JSONnewUsers;
          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              if (oldUsers.length === 0 || null) {
                ...
                oldUsers.forEach(function (element) {
