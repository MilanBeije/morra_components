...
var _bg = _interopRequireDefault(require("../assets/img/bg.png"));
var _wine = _interopRequireDefault(require("../assets/img/wine.png"));
var _beer = _interopRequireDefault(require("../assets/img/beer.png"));
var _martini = _interopRequireDefault(require("../assets/img/martini.png"));
var _play = _interopRequireDefault(require("../assets/img/play.png"));
var _oops = _interopRequireDefault(require("../assets/img/oops.png"));
var _cool = _interopRequireDefault(require("../assets/img/cool.png"));
var _versus = _interopRequireDefault(require("../assets/img/versus.png"));
var _win = _interopRequireDefault(require("../assets/img/win.png"));
var _gameover = _interopRequireDefault(require("../assets/img/gameover.png"));
var _InputCustom;
...
// arrray di icone
var IconArray = [_wine.default, _beer.default, _martini.default];
// colori
var brandColor = "#F752E0";
var secondaryColor = "#3DD8FC";
var tertiaryColor = "#FFE045";
...
var Game = function Game(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (state.attempts > 3) {
      ...
      if (state.allUsers.length > 0) {
        ...
        state.allUsers.forEach(function (element) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0, _getUsers.getCurrentUser)();
            case 2:
              user = _context.sent;
              _context.next = 5;
              return (0, _getUsers.getUsers)();
            case 5:
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              _context2.prev = 4;
              JSONnewUsers = JSON.stringify(state.allUsers);
              _context2.next = 8;
  ...
  var getUserMove = function getUserMove(index) {
    return function () {
      console.log(index);
      setState(_objectSpread(_objectSpread({}, state), {}, {
        movesUser: index
  ...
  var manageModal = function manageModal() {
    setState(_objectSpread(_objectSpread({}, state), {}, {
      showResult: 0
    }));
  };
  ...
  var getResult = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      var randomCpuChoice, battleResult;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              // randome cpu choice
              randomCpuChoice = Math.floor(Math.random() * 3); // eseguo il risultato
              battleResult = (0, _GameResult.GameResult)(state.movesUser, randomCpuChoice);
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
  ...
  }, state.endGame === false ? /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: {
      flex: 1
    }
  }, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    className: "statusGame",
  ...
  }, state.showResult !== 0 && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: {
      flex: 1,
      ...
      borderWidth: 2,
      borderRadius: 5,
      borderColor: "".concat(state.showResult === 1 ? secondaryColor : brandColor)
    }
    ...
    style: {
      color: "".concat(state.showResult === 1 ? secondaryColor : brandColor)
    }
  }, state.result.userLabel), /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
    style: {
      color: "".concat(state.showResult === 1 ? secondaryColor : brandColor)
    }
  }, state.result.cpuLabel), /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
    style: {
      color: "".concat(state.showResult === 1 ? secondaryColor : brandColor)
    }
  }, state.result.label), /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
    style: {
      color: "".concat(state.showResult === 1 ? secondaryColor : brandColor)
    }
  }, state.userPoints, " - ", state.cpuPoints), /*#__PURE__*/_react.default.createElement(_CustomButton.default, {
    label: "CHIUDI",
    buttonTextStyle: {
      color: "".concat(state.showResult === 1 ? brandColor : secondaryColor),
      fontSize: 15,
      fontWeight: "bold"
    },
    buttonContainerStyle: {
      backgroundColor: "".concat(state.showResult === 1 ? secondaryColor : brandColor),
      borderRadius: 5,
      width: 100,
      height: 30,
      marginVertical: 30,
  ...
  }, IconArray.map(function (element, key, index) {
    return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      key: key
    }, /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
      onPress: getUserMove(key)
    }, /*#__PURE__*/_react.default.createElement(_reactNative.Image, {
      source: element,
      style: {
        width: 100,
